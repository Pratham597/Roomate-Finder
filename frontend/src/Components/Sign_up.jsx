  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-cyan-50 via-sky-100 to-sky-100 rounded-lgjustify-center bg-white">
      <div className="w-full max-w-2xl p-8 bg-white rounded-2xl shadow-lg relative rounded-[35px] shadow-[10px_4px_4px_0px_rgba(0,0,0,0.25)] mb-10 mt-10">
        <h2 className="text-3xl font-bold text-left text-[#265669] mb-6">
          Sign Up
        </h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label
              htmlFor="name"
              className="block text-md font-medium text-[#367896] mb-2"
            >
              Name
            </label>
            <input
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("studyHabits", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("cleanliness", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("sleepingSchedule", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("personalSpace", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("internetUsage", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("noiseLevel", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("guestPolicies", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("longTermGoals", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("smokingDrinking", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={(e) =>
                handlePreferenceChange("dietaryPreferences", e.target.value)
              }
              className="w-full px-4 py-2 border-2 border-[#385F6E] rounded-full bg-[#F5FEFF] focus:outline focus:border-#01090D focus:bg-white transition-all"
            >
              <option value="">Select</option>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              onChange={(e) =>
                handlePreferenceChange("culturalPractices", e.target.value)
              }
          ...
          {/* Top Preferences */}
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-[#265669] mb-4">
              Top Preferences
            </h3>
            <p className="text-sm text-[#367896] mb-4">
